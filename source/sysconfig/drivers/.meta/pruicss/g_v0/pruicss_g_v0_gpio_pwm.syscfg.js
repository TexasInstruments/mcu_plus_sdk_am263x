...
function getPeripheralRequirements(inst, peripheralName)
{
    ...
    for(let pin of pinList)
    {
        ...
        /* make all pins as "rx" and then override to make "rx" as true as needed  */
...
function pinmuxRequirements(inst) {
    ...
    pinmux.setPeripheralPinConfigurableDefault( pwm, "TZ_IN", "rx", true);
...
let pruicss_top_module_name = "/drivers/pruicss/g_v0/pruicss_g_v0_gpio_pwm";
