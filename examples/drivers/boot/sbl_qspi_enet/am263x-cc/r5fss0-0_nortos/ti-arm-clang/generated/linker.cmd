...
SECTIONS
{
    .sbl_init_code  : {
        *(.vectors). = align(8);
    } load= MSRAM_VECS , run= R5F_VECS , palign(8) , fill  = 2882382797
    ...
    .bss.sbl_scratch (NOLOAD) : {
    } > MSRAM_2   , align(8) 

    .rodata.hsmrt  : {
    } > MSRAM_HSMRT   , palign(8) 
...
MEMORY
{
    ...
    MSRAM_0   : ORIGIN = 0x70002100 , LENGTH = 0x672E8 
    CPPI_DESC   : ORIGIN = 0x700693E8 , LENGTH = 0x4000 
    MSRAM_HSMRT   : ORIGIN = 0x7007C000 , LENGTH = 0x40000 
    MSRAM_1   : ORIGIN = 0x700BC000 , LENGTH = 0x13C000 
    MSRAM_2   : ORIGIN = 0x701F8000 , LENGTH = 0x8000 
